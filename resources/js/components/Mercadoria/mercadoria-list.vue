<template>
    <div>
        <template>
            <mercadoria-modal ref="edit"></mercadoria-modal>
            <mercadoria-view @edit="editar"></mercadoria-view>
            <v-card-title>
                <!--<v-spacer></v-spacer>-->
                <!--<v-spacer></v-spacer>-->
                <v-layout>
...
<script>
    ...
    import MercadoriaView from "./mercadoria-view";
    import MercadoriaModal from "./mercadoria-modal";
    export default {
        name: 'mercadoria-list',
        components: {MercadoriaModal, MercadoriaView},
        mounted() {
            this.setList()
        },
        computed: {
        ...
        methods: {
            ...
            ...mapActions('Mercadoria',['setList','view','delete_form']),
        }
    }
</script>
